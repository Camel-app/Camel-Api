...
const signup = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const email = (_b = (_a = req.body) === null || _a === void 0 ? void 0 : _a.email) !== null && _b !== void 0 ? _b : '';
    const password = (_d = (_c = req.body) === null || _c === void 0 ? void 0 : _c.password) !== null && _d !== void 0 ? _d : '';
    const existingResearcher = yield ((_e = connect_1.collections.researchers) === null || _e === void 0 ? void 0 : _e.findOne({ email: email }));
    ...
    try {
        const insertresult = yield ((_f = connect_1.collections.researchers) === null || _f === void 0 ? void 0 : _f.insertOne(researcher));
